...
# TODO : testar o tamanho dos dados retornados dentro da funcao para
# retornar uma excecao. Verificar se isso altera a ocorrencia do PROBLEMS ao mudar para "python.analysis.typeCheckingMode": "standard",
